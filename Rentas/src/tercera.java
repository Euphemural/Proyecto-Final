...
public class tercera extends Rentas {
	...
	private void initialize() {
		...
		Button button = new Button("Sencilla");
		button.setForeground(new Color(255, 255, 255));
		button.setBackground(new Color(0, 128, 192));
		button.setFont(new Font("Glacial Indifference", Font.PLAIN, 20));
		button.setBounds(306, 265, 79, 27);
		frame.getContentPane().add(button);
		
		Button button_1 = new Button("Doble");
		button_1.setForeground(new Color(255, 255, 255));
		button_1.setBackground(new Color(255, 0, 0));
		button_1.setFont(new Font("Glacial Indifference", Font.PLAIN, 20));
		button_1.setBounds(498, 265, 79, 27);
		frame.getContentPane().add(button_1);
		
		JLabel lblQueTipoDe = new JLabel("Que tipo de habitacion quieres consultar?");
		lblQueTipoDe.setForeground(new Color(255, 255, 255));
		lblQueTipoDe.setFont(new Font("Scripter", Font.PLAIN, 22));
		lblQueTipoDe.setBounds(255, 155, 397, 27);
		...
		panel_1_3_3_1.setBounds(352, 65, 173, 54);
		...
		JLabel lblNewLabel_1_1_1_1_2_3 = new JLabel("");
		lblNewLabel_1_1_1_1_2_3.setIcon(new ImageIcon("C:\\Users\\Tequila\\Downloads\\snapedit_1715629297483 (2).png"));
		lblNewLabel_1_1_1_1_2_3.setForeground(Color.WHITE);
		lblNewLabel_1_1_1_1_2_3.setFont(new Font("Scripter", Font.PLAIN, 22));
		lblNewLabel_1_1_1_1_2_3.setBounds(317, 201, 57, 55);
		frame.getContentPane().add(lblNewLabel_1_1_1_1_2_3);
		
		JLabel lblNewLabel_1_1_1_1_2_3_1 = new JLabel("");
		lblNewLabel_1_1_1_1_2_3_1.setIcon(new ImageIcon("C:\\Users\\Tequila\\Downloads\\snapedit_1715629297483 (2).png"));
		lblNewLabel_1_1_1_1_2_3_1.setForeground(Color.WHITE);
		lblNewLabel_1_1_1_1_2_3_1.setFont(new Font("Scripter", Font.PLAIN, 22));
		lblNewLabel_1_1_1_1_2_3_1.setBounds(510, 205, 57, 55);
		frame.getContentPane().add(lblNewLabel_1_1_1_1_2_3_1);
		
		JLabel lblseMuestranSolo = new JLabel("*Se muestran solo las habitaciones con reservas para el dia 15 de mayo de 2024*");
		lblseMuestranSolo.setForeground(new Color(255, 255, 255));
		lblseMuestranSolo.setFont(new Font("Scripter", Font.PLAIN, 14));
		lblseMuestranSolo.setBounds(221, 316, 455, 27);
		frame.getContentPane().add(lblseMuestranSolo);
		...
		panel_1_3_3_1_1.setBounds(202, 129, 474, 236);
