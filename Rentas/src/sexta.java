...
public class sexta extends Rentas {
	...
	private void initialize() {
		...
		JLabel lblDeMayo = new JLabel("Editar reserva");
		lblDeMayo.setBounds(12, 6, 154, 47);
		...
		lblNewLabel_1_1_1_1.setBounds(20, 18, 71, 27);
		...
		lblNewLabel_1.setBounds(19, 25, 253, 30);
		panel_1_3_3_1_1.add(lblNewLabel_1);
