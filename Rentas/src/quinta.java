...
public class quinta extends Rentas {
	...
	private void initialize() {
		...
		Button button_1_1_1 = new Button("Editar");
		button_1_1_1.setForeground(Color.WHITE);
		button_1_1_1.setFont(new Font("Glacial Indifference", Font.PLAIN, 20));
		button_1_1_1.setBackground(new Color(255, 128, 64));
		button_1_1_1.setBounds(108, 196, 79, 27);
